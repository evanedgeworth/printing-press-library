...
- Reconcile Supabase release and fail closed on scanner gaps (#4).

## 2026.7.2 - 2026-07-13

- fix(supabase): harden store scopes and exact Auth Admin lookup (#2).
...
- fix(supabase): preserve auth token source (#1278).
