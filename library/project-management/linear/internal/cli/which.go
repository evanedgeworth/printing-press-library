...
var whichIndex = []whichEntry{
	...
	{Command: "todos sync", Description: "Mirror agent TodoWrite hook payloads to [agent-todo] Linear subtasks under the session parent issue.", Group: "Agent-native plumbing", WhyItMatters: "Reach for this from Cursor/Claude PostToolUse hooks so plan todos become Linear subtasks immediately without linear-agent or hand-rolled GraphQL."},
